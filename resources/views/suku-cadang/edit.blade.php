...
@section('content')
    <h2>Edit Data Suku Cadang</h2>
    <br>

    <form action="{{ route('suku-cadang.update', $sukuCadang->id_suku_cadang) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nama_suku_cadang" id="nama_suku_cadang" value="{{ old('nama_suku_cadang', $sukuCadang->nama_suku_cadang) }}" maxlength="30" autocomplete="off" required oninput="this.value = this.value.toUpperCase();">
        ...
        <div class="mb-3">
            ...
            <input type="hidden" name="harga_satuan" id="harga_satuan" value="{{ old('harga_satuan', $sukuCadang->harga_satuan) }}" required> <!-- Input hidden untuk menyimpan angka asli -->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Set nilai awal dalam format rupiah saat halaman dimuat
            let hargaAwal = hargaInput.value;
            if (hargaAwal) {
                hargaFormat.value = formatRupiah(hargaAwal);
            }
