...
@section('content')
    ...
    <form action="{{ route('jasa.update', $jasa->id_jasa) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nama_jasa" id="nama_jasa" value="{{ old('nama_jasa', $jasa->nama_jasa) }}" maxlength="30" autocomplete="off" required oninput="this.value = this.value.toUpperCase();">
        ...
        <div class="mb-3">
            ...
            <input type="hidden" name="harga_satuan" id="harga_satuan" value="{{ old('harga_satuan', $jasa->harga_satuan) }}" required> <!-- Input hidden untuk menyimpan angka asli -->
            <div class="form-text">Masukkan harga dalam angka, maksimal 10 digit.</div>
        </div>

        <!-- Tombol Update dan Batal -->
        <div class="d-flex justify-content-end">
            <a href="{{ route('jasa.index') }}" class="btn btn-secondary me-2">Batal</a>
