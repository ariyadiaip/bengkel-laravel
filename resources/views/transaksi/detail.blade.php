...
<div class="container">
    ...
    <div class="button-container" style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 20px; margin-right: 10px margin-bottom: 20px;">
        <a href="{{ route('transaksi.index') }}" class="btn btn-secondary me-2">Kembali</a>
        <button type="button" class="btn btn-warning btn-sm flex-item" data-bs-toggle="modal" data-bs-target="#editModal" data-action="{{ route('transaksi.updateStatus', $transaksi->id_transaksi) }}">
